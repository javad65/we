...
import { SpecialStatusValueGridComponent } from '../special-status-value-grid/special-status-value-grid.component';
...
export class SpecialStatusValueComponent extends BaseComponent {
  ...
  @Output()
  changeStatus: EventEmitter<SelectionEvent> = new EventEmitter<SelectionEvent>();
